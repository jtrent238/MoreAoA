...
public class BiomeSlimetopia extends Biome {
	private static final BiomeProperties properties = new BiomeProperties("Slimetopia");
	...
	public BiomeSlimetopia() {
		...
		this.topBlock = BlockRegister.getUnmappedBlock("slimetopia_grass").getDefaultState();
		this.fillerBlock = BlockRegister.getUnmappedBlock("slimetopia_dirt").getDefaultState();
		this.spawnableCaveCreatureList.clear();
		this.spawnableCreatureList.clear();
		this.spawnableMonsterList.clear();
		this.spawnableWaterCreatureList.clear();
		this.decorator = new BiomeSlimetopiaDecorator();
	}
	...
	public class BiomeSlimetopiaDecorator extends AoABiomeDecorator {
		@Override
